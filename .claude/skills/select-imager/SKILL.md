...
7. Always pass the output of print_imager() to the user verbatum. Do not edit or modify in any way. If it does not have reasonable agreement with the previous step go back and figure out where the error was. Use the plotting tool and tell the user where the image is.
